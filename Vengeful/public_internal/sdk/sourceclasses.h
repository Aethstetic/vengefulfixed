...
namespace sdk {
	...
	struct ApplicationInstantCountersInfo_t
	{
		...
		uint32_t m_nDeferreuintptr_tsAllocated;
	};
	...
	public:
		...
		{
			typedef unsigned int(__thiscall *tGetPanel)(void*, int);
	...
	public:
		unsigned long create_font() {
			typedef unsigned long(__thiscall* OriginalFn)(void*);
		...
		void draw_set_text_position(int x, int y)
		{
		...
		{
			typedef void(__thiscall* oDrawOutlinedCircle)(void*, int, int, int, int);
...
#pragma pack(pop)
	...
	public:
		...
		{
			return *(CHandle<C_BasePlayer>*)((uintptr_t)this + 0x31C0);
		}
		...
		bool IsReloading()
		{
			static auto inReload = *(uint32_t*)((uintptr_t)utils->PatternScan(GetModuleHandleW(L"client.dll"), "C6 87 ? ? ? ? ? 8B 06 8B CE FF 90") + 2);
		...
		float GetInaccuracy()
		{
			...
			return VMT.getvfunc<oInaccuracy>(this, 469)(this);
		}

		float GetSpread()
		{
			return VMT.getvfunc<float(__thiscall*)(void*)>(this, 439)(this);
		}
	};
	...
	public:
		...
		virtual Vector& m_vecMins() const = 0;
		virtual Vector& m_vecMaxs() const = 0;
		virtual int& m_nSolidType() const = 0;
		virtual unsigned int& m_usSolidFlags() const = 0;
		virtual int& m_nSurroundType() const = 0;
		virtual int& m_triggerBloat() const = 0;
		virtual Vector& m_vecSpecifiedSurroundingMins() const = 0;
		virtual Vector& m_vecSpecifiedSurroundingMaxs() const = 0;
		virtual int& m_iTextureFrameIndex() const = 0;
		virtual bool& m_bSimulatedEveryTick() const = 0;
		virtual bool& m_bAnimatedEveryTick() const = 0;
		virtual bool& m_bAlternateSorting() const = 0;
	};
	...
	{
	public:
		ICollideable * m_Collision() const
		{
			return reinterpret_cast<ICollideable*>((uintptr_t)this + 0x0318);
		}
		QAngle & m_aimPunchAngle() const
		{
			return *reinterpret_cast<QAngle*>((uintptr_t)this + 0x301C);
		}

		float& m_flSimulationTime() const
		{
			return *reinterpret_cast<float*>((uintptr_t)this + 0x264);
		}

		bool& m_flLowerBodyYawTarget() const
		{
			return *reinterpret_cast<bool*>((uintptr_t)this + 0x39DC);
		}

		int& m_iGlowIndex() const
		{
			return *reinterpret_cast<int*>((uintptr_t)this + 0xA310);
		}

		CHandle<C_BaseViewModel>& m_hViewModel()
		{
			return *(CHandle<C_BaseViewModel>*)((uintptr_t)this + 0x32F0);
		}

		bool m_bIsScoped()
		{
			return *reinterpret_cast<bool*>((uintptr_t)this + 0x387C);
		}

		bool IsPlayer()
		{
			return VMT.getvfunc<bool(__thiscall*)(C_BasePlayer*)>(this, 152)(this);
		}
		...
		CHandle<C_BaseWeapon>& m_hActiveWeapon() const
		{
			...
			return *(CHandle<C_BaseWeapon>*)((uintptr_t)this + 0x2EE8);
		}

		CHandle<C_BaseWeapon>* m_hMyWeapons()
		{
			return (CHandle<C_BaseWeapon>*)((uintptr_t)this + 0x2DE8);
		}

		float Friction()
		{
			return *reinterpret_cast<float*>((uintptr_t)this + 0x140);
		}

		int m_iTeamNum()
		{
			return *reinterpret_cast<int*>((uintptr_t)this + 0xF0);
		}
		...
		int m_iHealth()
		{
			return *reinterpret_cast<int*>((uintptr_t)this + 0xFC);
		}
		...
		Vector GetEyePos()
		{
			return m_vecAbsOrigin() + *reinterpret_cast<Vector*>((uintptr_t)this + 0x104);
		}
		...
		bool IsWeapon()
		{
			return VMT.getvfunc<bool(__thiscall*)(C_BasePlayer*)>(this, 160)(this);
		}

		int m_nTickBase()
		{
			return *reinterpret_cast<int*>((uintptr_t)this + 0x3404);
		}

		float MaxSpeed()
		{
			return *reinterpret_cast<float*>((uintptr_t)this + 0x160C);
		}

		float GetFlashDuration()
		{
			return *reinterpret_cast<float*>((uintptr_t)this + 0xA2F8);
		}

		bool m_bGunGameImmunity()
		{
			return *reinterpret_cast<bool*>((uintptr_t)this + 0x3890);
		}
		...
		bool SetupBones(VMatrix *pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime)
		{
			...
			typedef bool(__thiscall* OriginalFn)(void*, VMatrix*, int, int, float);
		...
		model_t* GetModel()
		{
			typedef model_t*(__thiscall *OrigFn)(void*);
			return VMT.getvfunc<OrigFn>(GetRenderable(), 8)(GetRenderable());
		}
		...
		bool SetupBones(matrix3x4_t *pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime)
		{
			...
			return VMT.getvfunc<OrigFn>(pRenderable, 13)(pRenderable, pBoneToWorldOut, nMaxBones, boneMask, currentTime);
		}
		...
		Vector GetBonePos(int boneIndex)
		{
			...
			if (this->SetupBones(boneMatrix, MAXSTUDIOBONES, BONE_USED_BY_HITBOX, 0))
				return boneMatrix[boneIndex].at(3);
	...
	public:
		...
		{
			return *(CHandle<C_BaseWeapon>*)((uintptr_t)this + 0x29B8);
		}

		CHandle<C_BasePlayer>& m_hOwner()
		{
			return *(CHandle<C_BasePlayer>*)((uintptr_t)this + 0x29BC);
		}
	...
	extern CGlobalVarsBase* gobalvariables;
	extern IPanel* vguipanel;
	extern ISurface* vguisurface;
	extern IVModelRender* modelrender;
	extern IMaterialSystem* materialsytem;
	extern CInput* input;
	extern IClientEntityList* entitylist;
	extern IMDLCache* modelcache;
	extern IVEngineTrace* enginetrace;
	...
	template<typename type> extern type* get_interface(const char* module_name, const char* szInterfaceVersion);
	extern void initialize();

	inline IHandleEntity* CBaseHandle::Get() const
	{
		return entitylist->GetClientEntityFromHandle(*this);
	}
}
