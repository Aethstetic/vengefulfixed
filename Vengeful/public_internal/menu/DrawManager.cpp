...
void CRender::Init(IDirect3DDevice9* pDevice)
{
	...
	D3DXCreateFontA(this->device, 13, 0, FW_LIGHT, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY | NONANTIALIASED_QUALITY, DEFAULT_PITCH, "Tahoma", &this->fonts.fnormal);
	D3DXCreateFontA(this->device, 10, 0, FW_DONTCARE, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY | NONANTIALIASED_QUALITY, DEFAULT_PITCH, "Tahoma", &this->fonts.fsmall);
	D3DXCreateFontA(this->device, 12, 0, FW_DONTCARE, 1, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_QUALITY | NONANTIALIASED_QUALITY, DEFAULT_PITCH, "Arrows", &this->fonts.farrows);
...
void CRender::FilledCircleOutlined(int x, int y, int radius, int points, D3DCOLOR color, D3DCOLOR outlinecolor)
{
	FilledCircle(x, y, radius, points, color);
...
void CRender::CreateObjects()
{
	...
	GenerateTexture(this->device, &this->white_tex, D3DCOLOR_ARGB(255, 255, 255, 255));
